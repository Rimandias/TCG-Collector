...
const CardItem: React.FC<CardItemProps> = ({ card, user, onUpdateUser, onShowInfo }) => {
  ...
  return (
    <div className="flex flex-col gap-2 bg-white animate-in zoom-in-95 duration-200 group mb-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center bg-slate-50 border border-slate-200 rounded-full overflow-hidden h-8 shadow-sm">
