...
// Além disso, mesmo com uma URL válida, o CDN da TCGdex às vezes responde 503 (falha
// transitória, fora do nosso controle) - onError troca pra caixa vazia em vez de deixar
// o ícone de imagem quebrada do navegador, e reseta se a src mudar (troca de carta/coleção).
